...
public class MainActivity extends AppCompatActivity
        implements SharedPreferences.OnSharedPreferenceChangeListener, OnCompleteListener<Void> {
    ...
    private void populateGeofenceList() {
        ArrayList<HashMap<String, LatLng>> fences = new ArrayList();
        fences.add(Constants.RMV_LANDMARKS);
        fences.add(Constants.MENSA_LANDMARKS);

        for (HashMap<String, LatLng>  f : fences) {
            for (Map.Entry<String, LatLng> entry : f.entrySet()) {
